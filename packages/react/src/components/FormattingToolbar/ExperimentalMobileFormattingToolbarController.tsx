...
export const ExperimentalMobileFormattingToolbarController = (props: {
  ...
  useEffect(() => {
    ...
    const vk = (navigator as Navigator & { virtualKeyboard?: { overlaysContent: boolean; boundingRect: DOMRect; addEventListener: (type: string, listener: () => void) => void; removeEventListener: (type: string, listener: () => void) => void } })
      .virtualKeyboard;
    if (vk) {
